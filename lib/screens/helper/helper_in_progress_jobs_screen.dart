...
class HelperInProgressJobsScreen extends StatefulWidget {
  const HelperInProgressJobsScreen({super.key});

  @override
  State<HelperInProgressJobsScreen> createState() =>
      _HelperInProgressJobsScreenState();
}

class _HelperInProgressJobsScreenState
    extends State<HelperInProgressJobsScreen> {
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Employer: ${job.employer?.firstName ?? 'Unknown'}',
                                    style: const TextStyle(
                                      fontSize: 14,
